...
(function (global, factory) {
  ...
  function parseSpeed(speed) {
    ...
    if (typeof speed === 'string') {
      var speedStr = speed.toString().trim();

      // Speed extraction
      var speedValue = parseFloat(speedStr.replace(/^(-?[0-9]+(?:\.[0-9]*)?).*$/, '$1'));
      var speedUnit = speedStr.replace(/^-?[0-9]+(?:\.[0-9]*)?(.*)$/, '$1').trim();
  ...
  var Navbar = /*#__PURE__*/function (_AbstractComponent) {
    ...
    _proto.setButtons = function setButtons(buttons) {
      ...
      this.children.length = 0;
      var cleanedButtons = this.__cleanButtons(buttons);
  ...
  var DataHelper = /*#__PURE__*/function (_AbstractService) {
    ...
    _proto.speedToDuration = function speedToDuration(value, angle) {
      if (!value || typeof value !== 'number') {
        ...
        var speed = value ? parseSpeed(value) : this.config.autorotateSpeed;
        // compute duration
  ...
  var EventsHandler = /*#__PURE__*/function (_AbstractService) {
    ...
    _proto.__stopMoveInertia = function __stopMoveInertia(clientX, clientY) {
      ...
      var direction = curve.getTangent(1);
    ...
    _proto.__logMouseMove = function __logMouseMove(clientX, clientY) {
      var now = Date.now();
      var last = this.state.mouseHistory.length ? this.state.mouseHistory[this.state.mouseHistory.length - 1] : [0, -1, -1];
  ...
  var Viewer = /*#__PURE__*/function (_EventEmitter) {
    ...
    function Viewer(options) {
      ...
      _this.resize(_this.config.size);
      ...
      // init buttons
      _this.navbar.setButtons(_this.config.navbar);
    ...
    _proto.setPanorama = function setPanorama(path, options) {
      ...
      (_this$prop$transition = this.prop.transitionAnimation) == null ? void 0 : _this$prop$transition.cancel();
